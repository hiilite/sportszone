...
/**
 * SportsZone Customizer font size control.
 *
 * @since 2.5.0
 */
class SZ_Customizer_Control_Range extends WP_Customize_Control {
	/**
	 * @var string
	 */
	public $type = 'range';
	...
	public function enqueue() {
		wp_enqueue_script( 'sz-customizer-controls' );
		wp_enqueue_style( 'sz-customizer-controls' );
	}
