 ...
 * @since 2.2.0
 */
abstract class SZ_Recursive_Query {
	 ...
	 * For example, {@link SZ_XProfile_Query::get_sql()} is merely a wrapper for
	 * get_sql_clauses(), while {@link SZ_Activity_Query::get_sql()} discards
