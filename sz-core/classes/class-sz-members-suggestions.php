 ...
 * @since 2.1.0
 */
class SZ_Members_Suggestions extends SZ_Suggestions {
	...
	public function validate() {
		 ...
		 * @param SZ_Members_Suggestions $this Current SZ_Members_Suggestions instance.
		 */
		$this->args                 = apply_filters( 'sz_members_suggestions_args', $this->args, $this );

		// Check for invalid or missing mandatory parameters.
		if ( $this->args['only_friends'] && ( ! sz_is_active( 'friends' ) || ! is_user_logged_in() ) ) {
		 ...
		 * @param SZ_Members_Suggestions $this  Current SZ_Members_Suggestions instance.
		 */
		return apply_filters( 'sz_members_suggestions_validate_args', parent::validate(), $this );
	}
	...
	public function get_suggestions() {
		 ...
		 * @param SZ_Members_Suggestions $this       Current SZ_Members_Suggestions instance.
		 */
		$user_query = apply_filters( 'sz_members_suggestions_query_args', $user_query, $this );
		 ...
		 * @param SZ_Members_Suggestions $this    Current SZ_Members_Suggestions instance.
		 */
		return apply_filters( 'sz_members_suggestions_get_suggestions', $results, $this );
	}
}
