...
/**
 * Create a set of SportsZone-specific links for use in the Menus admin UI.
 *
 ...
 * @since 1.9.0
 */
class SZ_Walker_Nav_Menu_Checklist extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( ! in_array( array( 'sz-menu', 'sz-'. $item->post_excerpt .'-nav' ), $item->classes ) ) {
			$item->classes[] = 'sz-menu';
			$item->classes[] = 'sz-'. $item->post_excerpt .'-nav';
		}
