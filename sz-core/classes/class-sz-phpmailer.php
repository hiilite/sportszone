 ...
 * @since 2.5.0
 */
class SZ_PHPMailer implements SZ_Email_Delivery {
	...
	public function sz_email( SZ_Email $email ) {
		 ...
		 */
		$phpmailer = apply_filters( 'sz_phpmailer_object', $phpmailer );
		...
		$phpmailer->IsMail();
		$phpmailer->CharSet = sz_get_option( 'blog_charset' );
		 ...
		 */
		do_action( 'sz_phpmailer_init', $phpmailer );
