<?php
/**
 * SportsZone Core Theme Compatibility Base Class.
 *
 * @package SportsZone
 ...
 * for future Theme Packs to use. {@link SZ_Legacy} is a good example of
 * extending this class.
 *
 * @since 1.7.0
 *
 * @todo We should probably do something similar to SZ_Component::start().
...
class SZ_Theme_Compat {
	 ...
	 * @since 1.7.0
	 *
	 * @param array $properties Array of properties for SZ_Theme_Compat.
	 */
	...
	/**
	 * Set up the SportsZone-specific theme compat methods.
	 *
	 ...
	 * {@link SZ_Legacy::setup_globals()} for an example.
	 *
	 * @since 1.7.0
	 */
	 ...
	 *
	 * Meant to be overridden in your class. See
	 * {@link SZ_Legacy::setup_actions()} for an example.
	 *
	 * @since 1.7.0
	 */
