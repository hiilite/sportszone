 ...
 * @since 1.7.0
 */
class SZ_Walker_Nav_Menu extends Walker_Nav_Menu {
	 ...
	 *
	 * This caused a problem for SportsZone because our primary/secondary
	...
	public function walk( $elements, $max_depth ) {
		...
		foreach ( $elements as $e ) {
			// SportsZone: changed '==' to '==='. This is the only change from version in Walker::walk().
			if ( 0 === $e->$parent_field )
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		 ...
		 */
		$class_names = join( ' ', apply_filters( 'sz_nav_menu_css_class', array_filter( $item->class ), $item, $args ) );
		 ...
		 * @param array  $args Array of arguments for the item.
		 */
		$id = apply_filters( 'sz_nav_menu_item_id', $id, $item, $args );
		 ...
		 * @param array  $args        Array of arguments for the item.
		 */
		$output .= apply_filters( 'sz_walker_nav_menu_start_el', $item_output, $item, $depth, $args );
	}
}
