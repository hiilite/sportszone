<?php
/**
 * Backward compatibility for the $sz->sz_options_nav global.
 *
 * @since 2.6.0
 */
...
/**
 * sz_options_nav backward compatibility class.
 *
 * This class is used to provide backward compatibility for extensions that access and modify
 * the $sz->sz_options_nav global.
 *
 * @since 2.6.0
 */
class SZ_Core_SZ_Options_Nav_BackCompat extends SZ_Core_SZ_Nav_BackCompat {
	/**
	...
	public function offsetGet( $offset ) {
		_doing_it_wrong(
			'sz_nav',
			__( 'These globals should not be used directly and are deprecated. Please use the SportsZone nav functions instead.', 'sportszone' ),
			'2.6.0'
		);
