 ...
 * running and will alter the environment so SportsZone can run regardless.
 *
 ...
 */
function sz_get_major_wp_version() {
	global $wp_version;
 ...
 */
function sz_core_get_status_sql( $prefix = false ) {
	if ( !is_multisite() )
