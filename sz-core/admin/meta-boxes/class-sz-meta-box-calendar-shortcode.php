...
/**
 * SZ_Meta_Box_Calendar_Shortcode
 */
class SZ_Meta_Box_Calendar_Shortcode {
	...
	public static function output( $post ) {
		...
		<p><input type="text" value="<?php sz_shortcode_template( 'event_' . $the_format, $post->ID ); ?>" readonly="readonly" class="code widefat"></p>
		<?php
	}
}