...
class XProfile_Field extends BuddypressCommand {
	 ...
	 *
	 * [--<field>=<value>]
	 * : One or more parameters to pass. See sz_xprofile_get_groups()
	 *
	 * ## EXAMPLE
	 *
	...
	public function _list( $_, $assoc_args ) {
		...
		$groups    = sz_xprofile_get_groups( $args );
	...
	public function create( $args, $assoc_args ) {
		...
		if ( ! in_array( $assoc_args['type'], (array) sportszone()->profile->field_types, true ) ) {
