...
class Signup extends BuddypressCommand {
	...
	public function delete( $args, $assoc_args ) {
		...
		parent::_delete( array( $signup_id ), $assoc_args, function( $signup_id ) {
			if ( \SZ_Signup::delete( array( $signup_id ) ) ) {
	...
	public function activate( $args, $assoc_args ) {
		...
		$user_id = sz_core_activate_signup( $signup->activation_key );
	...
	public function resend( $args, $assoc_args ) {
		$signup = $this->get_signup_by_identifier( $args[0], $assoc_args );
		$send   = \SZ_Signup::resend( array( $signup->signup_id ) );
	 ...
	 *
	 * [--<field>=<value>]
	 * : One or more parameters to pass. See \SZ_Signup::get()
	 *
	 * [--<number>=<number>]
	...
	public function _list( $_, $assoc_args ) {
		...
		$signups = \SZ_Signup::get( $assoc_args );
	...
	protected function get_signup_by_identifier( $identifier, $assoc_args ) {
		...
		$signups = \SZ_Signup::get( $signup_args );
		$signup  = null;
