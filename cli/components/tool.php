...
class Tool extends BuddypressCommand {
	...
	public function repair( $args, $assoc_args ) {
		$repair = 'sz_admin_repair_' . $this->sanitize_string( $args[0] );
	...
	/**
	 * Display SportsZone version currently installed.
	 *
	 * ## EXAMPLE
	 *
	 *     $ wp bp tool version
	...
	public function version() {
		WP_CLI::line( 'SportsZone: ' . sz_get_version() );
	}
}
