Feature: Manage SportsZone Components
  ...
  Scenario: Component CRUD Operations
    ...
    Then STDOUT should be a table containing rows:
      ...
      | 1      | core    | Active    |  SportsZone Core   | It&#8216;s what makes <del>time travel</del> SportsZone possible! |
      | 2      | members | Inactive  |  Community Members | Everything in a SportsZone community revolves around its members. |
