...
WP_CLI::add_hook( 'before_wp_load', function() {
	...
	require_once( __DIR__ . '/components/sportszone.php' );
	...
	WP_CLI::add_command( 'sz', __NAMESPACE__ . '\\Command\\Buddypress', array(
		'before_invoke' => function() {
			if ( ! class_exists( 'Buddypress' ) ) {
				WP_CLI::error( 'The SportsZone plugin is not active.' );
			}
		},
	) );
