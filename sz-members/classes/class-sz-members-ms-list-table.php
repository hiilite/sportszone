<?php
/**
 * SportsZone Members List Table for Multisite.
 *
 * @package SportsZone
 ...
 * @since 2.0.0
 */
class SZ_Members_MS_List_Table extends WP_MS_Users_List_Table {
	...
	public function get_columns() {
		 ...
		 */
		return apply_filters( 'sz_members_ms_signup_columns', array(
	...
	?>
		<label class="screen-reader-text" for="signup_<?php echo intval( $signup_object->id ); ?>"><?php printf(
			...
			esc_html__( 'Select user: %s', 'sportszone' ), $signup_object->user_login );
		?></label>
	...
	public function column_username( $signup_object = null ) {
		...
		/** This filter is documented in sz-members/admin/sz-members-classes.php */
	...
	function column_default( $signup_object = null, $column_name = '' ) {
		 ...
		 */
		return apply_filters( 'sz_members_ms_signup_custom_column', '', $column_name, $signup_object );
	}
}
