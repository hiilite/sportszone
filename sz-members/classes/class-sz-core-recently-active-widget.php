<?php
/**
 * SportsZone Members Recently Active widget.
 *
 * @package SportsZone
 ...
 * @since 1.0.3
 */
class SZ_Core_Recently_Active_Widget extends WP_Widget {
	...
	public function __construct() {
		$name        = _x( '(SportsZone) Recently Active Members', 'widget name', 'sportszone' );
		$description = __( 'Profile photos of recently active members', 'sportszone' );
		parent::__construct( false, $name, array(
			'description'                 => $description,
			'classname'                   => 'widget_sz_core_recently_active_widget sportszone widget',
	...
	public function widget( $args, $instance ) {
		...
		<?php else: ?>
			...
			<div class="widget-error">
				<?php esc_html_e( 'There are no recently active members', 'sportszone' ); ?>
			</div>
	...
	public function parse_settings( $instance = array() ) {
		return sz_parse_args( $instance, array(
			'title' 	     => __( 'Recently Active Members', 'sportszone' ),
			'max_members' 	 => 15,
