<?php
/**
 * SportsZone Members Who's Online Widget.
 *
 * @package SportsZone
 ...
 * @since 1.0.3
 */
class SZ_Core_Whos_Online_Widget extends WP_Widget {
	...
	public function __construct() {
		$name        = _x( "(SportsZone) Who's Online", 'widget name', 'sportszone' );
		$description = __( 'Profile photos of online users', 'sportszone' );
		parent::__construct( false, $name, array(
			'description'                 => $description,
			'classname'                   => 'widget_sz_core_whos_online_widget sportszone widget',
	...
	public function widget( $args, $instance ) {
		...
		<?php else: ?>
			...
			<div class="widget-error">
				<?php esc_html_e( 'There are no users currently online', 'sportszone' ); ?>
			</div>
	...
	public function parse_settings( $instance = array() ) {
		return sz_parse_args( $instance, array(
			'title' 	     => __( "Who's Online", 'sportszone' ),
			'max_members' 	 => 15,
