 ...
 * @since 1.2.0
 */
function sz_activity_screen_groups() {
	 ...
	 * @since 1.2.0
	 */
	do_action( 'sz_activity_screen_groups' );
	 ...
	 */
	sz_core_load_template( apply_filters( 'sz_activity_template_groups_activity', 'members/single/home' ) );
}