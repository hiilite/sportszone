...
Tags: sportszone, hashtags, activity, bbPress, posts
Requires at least: WordPress 3.4 and SportsZone 1.6
Tested up to: WordPress 4.1 and SportsZone 2.1
Stable tag: 1.5.2

== Description ==

Hashtags for WordPress, SportsZone and bbPress. Adds hashtag links to SportsZone activity and bbPress topics. Hashtags turn into links that are used to search items based on topics.
