 ...
 */
function sz_settings_update_notification_settings( $user_id, $settings ) {
	$user_id = (int) $user_id;

	$settings = sz_settings_sanitize_notification_settings( $settings );
	foreach ( $settings as $setting_key => $setting_value ) {
		sz_update_user_meta( $user_id, $setting_key, $setting_value );
	}
}
 ...
 */
function sz_settings_sanitize_notification_settings( $settings = array() ) {
	...
	$registered_notification_settings = sz_settings_get_registered_notification_keys();
	...
	$core_notification_settings = array(
		...
		'notification_events_invite',
		'notification_events_event_updated',
		'notification_events_admin_promotion',
		'notification_events_membership_request',
...
/**
 * Build a dynamic whitelist of notification keys, based on what's hooked to 'sz_notification_settings'.
 *
 * @since 2.3.5
 *
 * @return array
 */
function sz_settings_get_registered_notification_keys() {
 ...
 * @return array
 */
function get_form_select_country_list($size = '') {
	if($size == 'full'):
	?>
