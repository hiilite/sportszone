<?php
/**
 * SportsZone Messages Thread Template Class.
 *
 * @package SportsZone
 ...
 */
class SZ_Messages_Thread_Template {
	 ...
	 * Constructor method.
	 *
	 * @see SZ_Messages_Thread::populate() for full parameter info.
	 *
	...
	public function __construct( $thread_id = 0, $order = 'ASC', $args = array() ) {
		$this->thread        = new SZ_Messages_Thread( $thread_id, $order, $args );
	 ...
	 *
	 * This method is used by {@link sz_thread_messages()} as part of the
	 * while loop that controls iteration inside the messages loop, eg:
	 *     while ( sz_thread_messages() ) { ...
	 *
	 * @see sz_thread_messages()
	 *
