<?php
/**
 * SportsZone Messages Sitewide Notices Widget.
 *
 * @package SportsZone
 * @subpackage Messages
 * @since 1.9.0
 ...
 * @since 1.9.0
 */
class SZ_Messages_Sitewide_Notices_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'sz_messages_sitewide_notices_widget',
			__( '(SportsZone) Sitewide Notices', 'sportszone' ),
			array(
				'classname'                   => 'widget_sz_core_sitewide_messages sportszone widget',
				'description'                 => __( 'Display Sitewide Notices posted by the site administrator', 'sportszone' ),
	...
	public function widget( $args, $instance ) {
		...
		$notices = SZ_Messages_Notice::get_active();
		if ( empty( $notices ) ) {
			return;
		}
		...
		<div class="sz-site-wide-message">
			<?php sz_message_get_notices(); ?>
		</div>
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'sportszone' ); ?></label>
