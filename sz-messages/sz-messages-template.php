<?php
/**
 * SportsZone Messages Template Tags.
 *
 * @package SportsZone
 ...
 * @since 1.0.0
 *
 * @global SZ_Messages_Box_Template $messages_template
 *
 ...
 */
function sz_has_message_threads( $args = array() ) {
	global $messages_template;

	// The default box the user is looking at.
	$current_action = sz_current_action();
	...
	$r = sz_parse_args( $args, array(
		...
		'page_arg'     => 'mpage', // See https://sportszone.trac.wordpress.org/ticket/3679.
		'meta_query'   => array()
	), 'has_message_threads' );

	// Load the messages loop global up with messages.
	$messages_template = new SZ_Messages_Box_Template( $r );
	 ...
	 * @param SZ_Messages_Box_Template $messages_template Current message box template object.
	 * @param array                    $r                 Array of parsed arguments passed into function.
	 */
	return apply_filters( 'sz_has_message_threads', $messages_template->has_threads(), $messages_template, $r );
}
 ...
 */
function sz_message_thread_id() {
	echo sz_get_message_thread_id();
}
	/**
	 ...
	 * @return int
	 */
	function sz_get_message_thread_id() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_id', $messages_template->thread->thread_id );
	}

/**
 * Output the subject of the current thread in the loop.
 */
function sz_message_thread_subject() {
	echo sz_get_message_thread_subject();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_subject() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_subject', $messages_template->thread->last_message_subject );
	}

/**
 * Output an excerpt from the current message in the loop.
 */
function sz_message_thread_excerpt() {
	echo sz_get_message_thread_excerpt();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_excerpt() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_excerpt', strip_tags( sz_create_excerpt( $messages_template->thread->last_message_content, 75 ) ) );
	}
 ...
 * @since 2.0.0
 */
function sz_message_thread_content() {
	echo sz_get_message_thread_content();
}
	/**
	 ...
	 */
	function sz_get_message_thread_content() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_content', $messages_template->thread->last_message_content );
	}

/**
 * Output a link to the page of the current thread's last author.
 */
function sz_message_thread_from() {
	echo sz_get_message_thread_from();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_from() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_from', sz_core_get_userlink( $messages_template->thread->last_sender_id ) );
	}

/**
 * Output links to the pages of the current thread's recipients.
 */
function sz_message_thread_to() {
	echo sz_get_message_thread_to();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_to() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_message_thread_to', SZ_Messages_Thread::get_recipient_links($messages_template->thread->recipients ) );
	}
 ...
 */
function sz_message_thread_view_link( $thread_id = 0, $user_id = null ) {
	echo sz_get_message_thread_view_link( $thread_id, $user_id );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_view_link( $thread_id = 0, $user_id = null ) {
		global $messages_template;
		...
		$domain = sz_core_get_user_domain( $user_id );
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_view_link', trailingslashit( $domain . sz_get_messages_slug() . '/view/' . $thread_id ), $thread_id, $user_id );
	}
 ...
 *                     should be generated. Default: ID of logged-in user.
 */
function sz_message_thread_delete_link( $user_id = null ) {
	echo esc_url( sz_get_message_thread_delete_link( $user_id ) );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_delete_link( $user_id = null ) {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_delete_link', wp_nonce_url( trailingslashit( $domain . sz_get_messages_slug() . '/' . sz_current_action() . '/delete/' . $messages_template->thread->thread_id ), 'messages_delete_thread' ), $user_id );
	}
 ...
 *                     should be generated. Default: ID of logged-in user.
 */
function sz_the_message_thread_mark_unread_url( $user_id = null ) {
	echo esc_url( sz_get_the_message_thread_mark_unread_url( $user_id ) );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_message_thread_mark_unread_url( $user_id = null ) {
		...
		// Base unread URL.
		$url = trailingslashit( $domain . sz_get_messages_slug() . '/' . sz_current_action() . '/unread' );

		// Add the args to the URL.
		$url = add_query_arg( $args, $url );

		// Add the nonce.
		$url = wp_nonce_url( $url, 'sz_message_thread_mark_unread_' . $id );
		 ...
		 * @param int    $user_id ID of the user relative to whom the link should be generated.
		 */
		return apply_filters( 'sz_get_the_message_thread_mark_unread_url', $url, $user_id );
	}
 ...
 *                     should be generated. Default: ID of logged-in user.
 */
function sz_the_message_thread_mark_read_url( $user_id = null ) {
	echo esc_url( sz_get_the_message_thread_mark_read_url( $user_id ) );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_message_thread_mark_read_url( $user_id = null ) {
		...
		// Base read URL.
		$url = trailingslashit( $domain . sz_get_messages_slug() . '/' . sz_current_action() . '/read' );

		// Add the args to the URL.
		$url = add_query_arg( $args, $url );

		// Add the nonce.
		$url = wp_nonce_url( $url, 'sz_message_thread_mark_read_' . $id );
		 ...
		 * @param int    $user_id ID of the user relative to whom the link should be generated.
		 */
		return apply_filters( 'sz_get_the_message_thread_mark_read_url', $url );
	}

/**
 * Output the CSS class for the current thread.
 */
function sz_message_css_class() {
	echo esc_attr( sz_get_message_css_class() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_css_class() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_css_class', trim( $class ) );
	}
 ...
 */
function sz_message_thread_has_unread() {
	global $messages_template;
	 ...
	 */
	return apply_filters( 'sz_message_thread_has_unread', $retval );
}

/**
 * Output the current thread's unread count.
 */
function sz_message_thread_unread_count() {
	echo esc_html( sz_get_message_thread_unread_count() );
}
	/**
	 ...
	 * @return int
	 */
	function sz_get_message_thread_unread_count() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_unread_count', $count );
	}
 ...
 */
function sz_message_thread_total_count( $thread_id = false ) {
	echo sz_get_message_thread_total_count( $thread_id );
}
	/**
	 ...
	 * @return int
	 */
	function sz_get_message_thread_total_count( $thread_id = false ) {
		if ( false === $thread_id ) {
			$thread_id = sz_get_message_thread_id();
		}

		$thread_template = new SZ_Messages_Thread_Template( $thread_id, 'ASC', array(
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_total_count', $count, $thread_id );
	}
 ...
 */
function sz_message_thread_total_and_unread_count( $thread_id = false ) {
	echo sz_get_message_thread_total_and_unread_count( $thread_id );
}
	/**
	 ...
	 */
	function sz_get_message_thread_total_and_unread_count( $thread_id = false ) {
		if ( false === $thread_id ) {
			$thread_id = sz_get_message_thread_id();
		}

		$total  = sz_get_message_thread_total_count( $thread_id );
		$unread = sz_get_message_thread_unread_count( $thread_id );

		return sprintf(
			/* translators: 1: total number, 2: accessibility text: number of unread messages */
			'<span class="thread-count">(%1$s)</span> <span class="sz-screen-reader-text">%2$s</span>',
			number_format_i18n( $total ),
			sprintf( _n( '%d unread', '%d unread', $unread, 'sportszone' ), number_format_i18n( $unread ) )
		);
	}
 ...
 */
function sz_message_thread_last_post_date_raw() {
	echo sz_get_message_thread_last_post_date_raw();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_last_post_date_raw() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_last_message_date', $messages_template->thread->last_message_date );
	}

/**
 * Output the nicely formatted date of the last post in the current thread.
 */
function sz_message_thread_last_post_date() {
	echo sz_get_message_thread_last_post_date();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_thread_last_post_date() {
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_last_post_date', sz_format_time( strtotime( sz_get_message_thread_last_post_date_raw() ) ) );
	}

/**
 * Output the avatar for the last sender in the current message thread.
 *
 * @see sz_get_message_thread_avatar() for a description of arguments.
 *
 * @param array|string $args See {@link sz_get_message_thread_avatar()}.
 */
function sz_message_thread_avatar( $args = '' ) {
	echo sz_get_message_thread_avatar( $args );
}
	/**
	 ...
	 */
	function sz_get_message_thread_avatar( $args = '' ) {
		global $messages_template;

		$fullname = sz_core_get_user_displayname( $messages_template->thread->last_sender_id );
		 ...
		 */
		return apply_filters( 'sz_get_message_thread_avatar', sz_core_fetch_avatar( array(
 ...
 */
function sz_total_unread_messages_count( $user_id = 0 ) {
	echo sz_get_total_unread_messages_count( $user_id );
}
	/**
	 ...
	 * @return int $unread_count Total inbox unread count for user.
	 */
	function sz_get_total_unread_messages_count( $user_id = 0 ) {
		 ...
		 */
		return apply_filters( 'sz_get_total_unread_messages_count', SZ_Messages_Thread::get_inbox_count( $user_id ) );
	}

/**
 * Output the pagination HTML for the current thread loop.
 */
function sz_messages_pagination() {
	echo sz_get_messages_pagination();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_messages_pagination() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_messages_pagination', $messages_template->pag_links );
	}

/**
 * Generate the "Viewing message x to y (of z messages)" string for a loop.
 */
function sz_messages_pagination_count() {
	global $messages_template;

	$start_num = intval( ( $messages_template->pag_page - 1 ) * $messages_template->pag_num ) + 1;
	$from_num  = sz_core_number_format( $start_num );
	$to_num    = sz_core_number_format( ( $start_num + ( $messages_template->pag_num - 1 ) > $messages_template->total_thread_count ) ? $messages_template->total_thread_count : $start_num + ( $messages_template->pag_num - 1 ) );
	$total     = sz_core_number_format( $messages_template->total_thread_count );

	if ( 1 == $messages_template->total_thread_count ) {
		$message = __( 'Viewing 1 message', 'sportszone' );
	} else {
		$message = sprintf( _n( 'Viewing %1$s - %2$s of %3$s message', 'Viewing %1$s - %2$s of %3$s messages', $messages_template->total_thread_count, 'sportszone' ), $from_num, $to_num, $total );
	}
 ...
 * @since 1.6.0
 */
function sz_message_search_form() {

	// Get the default search text.
	$default_search_value = sz_get_search_default_text( 'messages' );
	...
	<form action="" method="get" id="search-message-form">
		<label for="messages_search" class="sz-screen-reader-text"><?php
			/* translators: accessibility text */
			esc_html_e( 'Search Messages', 'sportszone' );
		?></label>
		<input type="text" name="s" id="messages_search"<?php echo $search_placeholder . $search_value; ?> />
		<input type="submit" class="button" id="messages_search_submit" name="messages_search_submit" value="<?php esc_html_e( 'Search', 'sportszone' ); ?>" />
	</form>
	 ...
	 */
	echo apply_filters( 'sz_message_search_form', $search_form_html );
}

/**
 * Echo the form action for Messages HTML forms.
 */
function sz_messages_form_action() {
	echo esc_url( sz_get_messages_form_action() );
}
	/**
	 ...
	 */
	function sz_get_messages_form_action() {
		 ...
		 */
		return apply_filters( 'sz_get_messages_form_action', trailingslashit( sz_displayed_user_domain() . sz_get_messages_slug() . '/' . sz_current_action() . '/' . sz_action_variable( 0 ) ) );
	}

/**
 * Output the default username for the recipient box.
 */
function sz_messages_username_value() {
	echo esc_attr( sz_get_messages_username_value() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_messages_username_value() {
		if ( isset( $_COOKIE['sz_messages_send_to'] ) ) {

			/**
			 * Filters the default username for the recipient box.
			 *
			 * Value passed into filter is dependent on if the 'sz_messages_send_to'
			 ...
			 */
			return apply_filters( 'sz_get_messages_username_value', $_COOKIE['sz_messages_send_to'] );
		} elseif ( isset( $_GET['r'] ) && !isset( $_COOKIE['sz_messages_send_to'] ) ) {
			/** This filter is documented in sz-messages-template.php */
			return apply_filters( 'sz_get_messages_username_value', $_GET['r'] );
		}
	}
 ...
 */
function sz_messages_subject_value() {
	echo esc_attr( sz_get_messages_subject_value() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_messages_subject_value() {

		// Sanitized in sz-messages-filters.php.
		 ...
		 */
		return apply_filters( 'sz_get_messages_subject_value', $subject );
	}

/**
 * Output the default value for the Compose content field.
 */
function sz_messages_content_value() {
	echo esc_textarea( sz_get_messages_content_value() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_messages_content_value() {
		 ...
		 */
		return apply_filters( 'sz_get_messages_content_value', $content );
	}

/**
 * Output the markup for the message type dropdown.
 */
function sz_messages_options() {
?>

	<label for="message-type-select" class="sz-screen-reader-text"><?php
		/* translators: accessibility text */
		_e( 'Select:', 'sportszone' );
	?></label>
	<select name="message-type-select" id="message-type-select">
		<option value=""><?php _e( 'Select', 'sportszone' ); ?></option>
		<option value="read"><?php _ex('Read', 'Message dropdown filter', 'sportszone') ?></option>
		<option value="unread"><?php _ex('Unread', 'Message dropdown filter', 'sportszone') ?></option>
		<option value="all"><?php _ex('All', 'Message dropdown filter', 'sportszone') ?></option>
	</select> &nbsp;

	<?php if ( ! sz_is_current_action( 'sentbox' ) && ! sz_is_current_action( 'notices' ) ) : ?>

		<a href="#" id="mark_as_read"><?php _ex('Mark as Read', 'Message management markup', 'sportszone') ?></a> &nbsp;
		<a href="#" id="mark_as_unread"><?php _ex('Mark as Unread', 'Message management markup', 'sportszone') ?></a> &nbsp;

		<?php wp_nonce_field( 'sz_messages_mark_messages_read', 'mark-messages-read-nonce', false ); ?>
		<?php wp_nonce_field( 'sz_messages_mark_messages_unread', 'mark-messages-unread-nonce', false ); ?>

	<?php endif; ?>

	<a href="#" id="delete_<?php echo sz_current_action(); ?>_messages"><?php _e( 'Delete Selected', 'sportszone' ); ?></a> &nbsp;
	<?php wp_nonce_field( 'sz_messages_delete_selected', 'delete-selected-nonce', false ); ?>
<?php
}
 ...
 * @since 2.2.0
 */
function sz_messages_bulk_management_dropdown() {
	?>
	<label class="sz-screen-reader-text" for="messages-select"><?php
		_e( 'Select Bulk Action', 'sportszone' );
	?></label>
	<select name="messages_bulk_action" id="messages-select">
		<option value="" selected="selected"><?php _e( 'Bulk Actions', 'sportszone' ); ?></option>
		<option value="read"><?php _e( 'Mark read', 'sportszone' ); ?></option>
		<option value="unread"><?php _e( 'Mark unread', 'sportszone' ); ?></option>
		<option value="delete"><?php _e( 'Delete', 'sportszone' ); ?></option>
		<?php
			/**
			 ...
			 * @since 2.3.0
			 */
			do_action( 'sz_messages_bulk_management_dropdown' );
		?>
	</select>
	<input type="submit" id="messages-bulk-manage" class="button action" value="<?php esc_attr_e( 'Apply', 'sportszone' ); ?>">
	<?php
}
 ...
 * @return bool
 */
function sz_messages_is_active_notice() {
	global $messages_template;
	 ...
	 */
	return apply_filters( 'sz_messages_is_active_notice', $retval );
}
 ...
 * @return bool
 */
function sz_message_is_active_notice() {
	echo sz_get_message_is_active_notice();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_is_active_notice() {

		$string = sz_messages_is_active_notice()
			? __( 'Currently Active', 'sportszone' )
			: '';

		return apply_filters( 'sz_get_message_is_active_notice', $string );
	}

/**
 * Output the ID of the current notice in the loop.
 */
function sz_message_notice_id() {
	echo (int) sz_get_message_notice_id();
}
	/**
	 ...
	 * @return int
	 */
	function sz_get_message_notice_id() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_notice_id', $messages_template->thread->id );
	}

/**
 * Output the post date of the current notice in the loop.
 */
function sz_message_notice_post_date() {
	echo sz_get_message_notice_post_date();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_notice_post_date() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_notice_post_date', sz_format_time( strtotime( $messages_template->thread->date_sent ) ) );
	}

/**
 * Output the subject of the current notice in the loop.
 */
function sz_message_notice_subject() {
	echo sz_get_message_notice_subject();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_notice_subject() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_notice_subject', $messages_template->thread->subject );
	}

/**
 * Output the text of the current notice in the loop.
 */
function sz_message_notice_text() {
	echo sz_get_message_notice_text();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_notice_text() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_notice_text', $messages_template->thread->message );
	}

/**
 * Output the URL for deleting the current notice.
 */
function sz_message_notice_delete_link() {
	echo esc_url( sz_get_message_notice_delete_link() );
}
	/**
	 ...
	 */
	function sz_get_message_notice_delete_link() {
		global $messages_template;
		 ...
		 */
		return apply_filters( 'sz_get_message_notice_delete_link', wp_nonce_url( trailingslashit( sz_loggedin_user_domain() . sz_get_messages_slug() . '/notices/delete/' . $messages_template->thread->id ), 'messages_delete_notice' ) );
	}

/**
 * Output the URL for deactivating the current notice.
 */
function sz_message_activate_deactivate_link() {
	echo esc_url( sz_get_message_activate_deactivate_link() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_activate_deactivate_link() {
		global $messages_template;

		if ( 1 === (int) $messages_template->thread->is_active ) {
			$link = wp_nonce_url( trailingslashit( sz_loggedin_user_domain() . sz_get_messages_slug() . '/notices/deactivate/' . $messages_template->thread->id ), 'messages_deactivate_notice' );
		} else {
			$link = wp_nonce_url( trailingslashit( sz_loggedin_user_domain() . sz_get_messages_slug() . '/notices/activate/' . $messages_template->thread->id ), 'messages_activate_notice' );
		}
		 ...
		 */
		return apply_filters( 'sz_get_message_activate_deactivate_link', $link );
	}

/**
 * Output the Deactivate/Activate text for the notice action link.
 */
function sz_message_activate_deactivate_text() {
	echo esc_html( sz_get_message_activate_deactivate_text() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_activate_deactivate_text() {
		global $messages_template;

		if ( 1 === (int) $messages_template->thread->is_active  ) {
			$text = __('Deactivate', 'sportszone');
		} else {
			$text = __('Activate', 'sportszone');
		}
		 ...
		 */
		return apply_filters( 'sz_message_activate_deactivate_text', $text );
	}
 ...
 *
 */
function sz_messages_slug() {
	echo sz_get_messages_slug();
}
	/**
	...
	function sz_get_messages_slug() {
		 ...
		 */
		return apply_filters( 'sz_get_messages_slug', sportszone()->messages->slug );
	}

/**
 * Generate markup for currently active notices.
 */
function sz_message_get_notices() {
	...
	$closed_notices = sz_get_user_meta( sz_loggedin_user_id(), 'closed_notices', true );
		...
		if ( !in_array( $notice->id, $closed_notices ) && $notice->id ) {
			...
			<div id="message" class="info notice" rel="n-<?php echo esc_attr( $notice->id ); ?>">
				<p>
					...
					<button type="button" id="close-notice" class="sz-tooltip" data-sz-tooltip="<?php esc_attr_e( 'Dismiss this notice', 'sportszone' ) ?>"><span class="sz-screen-reader-text"><?php _e( 'Dismiss this notice', 'sportszone' ) ?></span> <span aria-hidden="true">&Chi;</span></button>
					<?php wp_nonce_field( 'sz_messages_close_notice', 'close-notice-nonce' ); ?>
				</p>
			</div>
			<?php
		}
 ...
 */
function sz_send_private_message_link() {
	echo esc_url( sz_get_send_private_message_link() );
}
	/**
	 ...
	 */
	function sz_get_send_private_message_link() {

		if ( sz_is_my_profile() || ! is_user_logged_in() ) {
			return false;
		}
		 ...
		 */
		return apply_filters( 'sz_get_send_private_message_link', wp_nonce_url( sz_loggedin_user_domain() . sz_get_messages_slug() . '/compose/?r=' . sz_core_get_username( sz_displayed_user_id() ) ) );
	}
 ...
 *
 */
function sz_send_private_message_button() {
	echo sz_get_send_message_button();
}
 ...
 *
 * @param array|string $args See {@link sz_get_send_message_button()}.
 */
function sz_send_message_button( $args = '' ) {
	echo sz_get_send_message_button( $args );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_send_message_button( $args = '' ) {
		...
		$r = sz_parse_args( $args, array(
			...
			'link_href'         => sz_get_send_private_message_link(),
			'link_text'         => __( 'Private Message', 'sportszone' ),
			'link_class'        => 'send-message',
		) );


		// Note: 'sz_get_send_message_button' is a legacy filter. Use
		// 'sz_get_send_message_button_args' instead. See #4536.
		return apply_filters( 'sz_get_send_message_button',
			 ...
			 * @since 1.8.0
			 *
			 * @param array $value See {@link SZ_Button}.
			 */
			sz_get_button( apply_filters( 'sz_get_send_message_button_args', $r ) )
		);
	}
 ...
 */
function sz_message_loading_image_src() {
	echo esc_url( sz_get_message_loading_image_src() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_loading_image_src() {
		 ...
		 */
		return apply_filters( 'sz_get_message_loading_image_src', sportszone()->messages->image_base . '/ajax-loader.gif' );
	}

/**
 * Output the markup for the message recipient tabs.
 */
function sz_message_get_recipient_tabs() {
	$recipients = explode( ' ', sz_get_message_get_recipient_usernames() );

	foreach ( $recipients as $recipient ) {

		$user_id = sz_is_username_compatibility_mode()
			? sz_core_get_userid( $recipient )
			: sz_core_get_userid_from_nicename( $recipient );

		if ( ! empty( $user_id ) ) : ?>

			<li id="un-<?php echo esc_attr( $recipient ); ?>" class="friend-tab">
				<span><?php
					echo sz_core_fetch_avatar( array( 'item_id' => $user_id, 'type' => 'thumb', 'width' => 15, 'height' => 15 ) );
					echo sz_core_get_userlink( $user_id );
				?></span>
			</li>
 ...
 */
function sz_message_get_recipient_usernames() {
	echo esc_attr( sz_get_message_get_recipient_usernames() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_message_get_recipient_usernames() {
		 ...
		 */
		return apply_filters( 'sz_get_message_get_recipient_usernames', $recipients );
	}
 ...
 */
function sz_thread_has_messages( $args = '' ) {
	...
	if ( empty( $r['thread_id'] ) && sz_is_messages_component() && sz_is_current_action( 'view' ) ) {
		$r['thread_id'] = (int) sz_action_variable( 0 );
	}
	...
	$thread_template = new SZ_Messages_Thread_Template( $r['thread_id'], $r['order'], $extra_args );
 ...
 */
function sz_thread_messages_order() {
	echo esc_attr( sz_get_thread_messages_order() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_thread_messages_order() {
		global $thread_template;
 ...
 * @return object
 */
function sz_thread_the_message() {
	global $thread_template;
 ...
 */
function sz_the_thread_id() {
	echo (int) sz_get_the_thread_id();
}
	/**
	...
	function sz_get_the_thread_id() {
		 ...
		 * @param int $thread_id ID of the thread.
		 */
		return apply_filters( 'sz_get_the_thread_id', $thread_template->thread->thread_id );
	}

/**
 * Output the subject of the thread currently being iterated over.
 */
function sz_the_thread_subject() {
	echo sz_get_the_thread_subject();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_subject() {
		global $thread_template;
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_subject', $thread_template->thread->last_message_subject );
	}

/**
 * Get a list of thread recipients or a "x recipients" string.
 *
 * In SportsZone 2.2.0, this parts of this functionality were moved into the
 * members/single/messages/single.php template. This function is no longer used
 * by SportsZone.
 *
 * @return string
 */
function sz_get_the_thread_recipients() {
	if ( 5 <= sz_get_thread_recipients_count() ) {
		$recipients = sprintf( __( '%s recipients', 'sportszone' ), number_format_i18n( sz_get_thread_recipients_count() ) );
	} else {
		$recipients = sz_get_thread_recipients_list();
	}

	return apply_filters( 'sz_get_the_thread_recipients', $recipients );
}
 ...
 * @return int
 */
function sz_get_thread_recipients_count() {
	global $thread_template;
	/**
	 ...
	 */
	return (int) apply_filters( 'sz_get_thread_recipients_count', count( $thread_template->thread->recipients ) );
}
 ...
 * @return int
 */
function sz_get_max_thread_recipients_to_list() {
	/**
	 ...
	 */
	return (int) apply_filters( 'sz_get_max_thread_recipients_to_list', 5 );
}
 ...
 * @since 2.2.0
 */
function sz_the_thread_recipients_list() {
	echo sz_get_thread_recipients_list();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_thread_recipients_list() {
		global $thread_template;

		$recipient_links = array();

		foreach( (array) $thread_template->thread->recipients as $recipient ) {
			if ( (int) $recipient->user_id !== sz_loggedin_user_id() ) {
				$recipient_link = sz_core_get_userlink( $recipient->user_id );

				if ( empty( $recipient_link ) ) {
					$recipient_link = __( 'Deleted User', 'sportszone' );
				}

				$recipient_links[] = $recipient_link;
			} else {
				$recipient_links[] = __( 'you', 'sportszone' );
			}
		}
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_recipients_list', $recipient_links );
	}
 ...
 * @since 1.9.0
 */
function sz_the_thread_message_id() {
	echo (int) sz_get_the_thread_message_id();
}
	/**
	 ...
	 * @return int
	 */
	function sz_get_the_thread_message_id() {
		global $thread_template;
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_id', $thread_message_id );
	}
 ...
 * @since 2.1.0
 */
function sz_the_thread_message_css_class() {
	echo esc_attr( sz_get_the_thread_message_css_class() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_message_css_class() {
		global $thread_template;

		$classes = array();

		// Zebra-striping.
		$classes[] = sz_get_the_thread_message_alt_class();

		// ID of the sender.
		$classes[] = 'sent-by-' . intval( $thread_template->message->sender_id );

		// Whether the sender is the same as the logged-in user.
		if ( sz_loggedin_user_id() == $thread_template->message->sender_id ) {
			$classes[] = 'sent-by-me';
		}
		 ...
		 */
		$classes = apply_filters( 'sz_get_the_thread_message_css_class', $classes );
 ...
 */
function sz_the_thread_message_alt_class() {
	echo esc_attr( sz_get_the_thread_message_alt_class() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_message_alt_class() {
		global $thread_template;
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_alt_class', $class );
	}
 ...
 * @since 2.1.0
 */
function sz_the_thread_message_sender_id() {
	echo (int) sz_get_the_thread_message_sender_id();
}
	/**
	 ...
	 * @return int
	 */
	function sz_get_the_thread_message_sender_id() {
		global $thread_template;
		 ...
		 */
		return (int) apply_filters( 'sz_get_the_thread_message_sender_id', (int) $user_id );
	}

/**
 * Output the avatar for the current message sender.
 *
 * @param array|string $args See {@link sz_get_the_thread_message_sender_avatar_thumb()}
 *                           for a description.
 */
function sz_the_thread_message_sender_avatar( $args = '' ) {
	echo sz_get_the_thread_message_sender_avatar_thumb( $args );
}
	/**
	 * Get the avatar for the current message sender.
	 *
	 * @param array|string $args {
	 *     Array of arguments. See {@link sz_core_fetch_avatar()} for more
	 ...
	 */
	function sz_get_the_thread_message_sender_avatar_thumb( $args = '' ) {
		global $thread_template;
		 ...
		 * @param array  $r     Array of parsed arguments.
		 */
		return apply_filters( 'sz_get_the_thread_message_sender_avatar_thumb', sz_core_fetch_avatar( array(
			'item_id' => $thread_template->message->sender_id,
			'type'    => $r['type'],
			'width'   => $r['width'],
			'height'  => $r['height'],
			'alt'     => sz_core_get_user_displayname( $thread_template->message->sender_id )
		) ), $r );
	}
 ...
 * @since 1.1.0
 */
function sz_the_thread_message_sender_link() {
	echo esc_url( sz_get_the_thread_message_sender_link() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_message_sender_link() {
		global $thread_template;
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_sender_link', sz_core_get_userlink( $thread_template->message->sender_id, false, true ) );
	}
 ...
 * @since 1.1.0
 */
function sz_the_thread_message_sender_name() {
	echo esc_html( sz_get_the_thread_message_sender_name() );
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_message_sender_name() {
		global $thread_template;

		$display_name = sz_core_get_user_displayname( $thread_template->message->sender_id );

		if ( empty( $display_name ) ) {
			$display_name = __( 'Deleted User', 'sportszone' );
		}
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_sender_name', $display_name );
	}
 ...
 * @since 1.5.0
 */
function sz_the_thread_delete_link() {
	echo esc_url( sz_get_the_thread_delete_link() );
}
	/**
	 ...
	 * @return string URL
	 */
	function sz_get_the_thread_delete_link() {
		 ...
		 * @param string $value Text indicating action being executed.
		 */
		return apply_filters( 'sz_get_message_thread_delete_link', wp_nonce_url( sz_displayed_user_domain() . sz_get_messages_slug() . '/inbox/delete/' . sz_get_the_thread_id(), 'messages_delete_thread' ) );
	}
 ...
 * @since 1.1.0
 */
function sz_the_thread_message_time_since() {
	echo sz_get_the_thread_message_time_since();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_message_time_since() {
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_time_since', sprintf( __( 'Sent %s', 'sportszone' ), sz_core_time_since( sz_get_the_thread_message_date_sent() ) ) );
	}
 ...
 * @since 2.1.0
 */
function sz_the_thread_message_date_sent() {
	echo sz_get_the_thread_message_date_sent();
}
	/**
	 * Generate the 'Sent x hours ago' string for the current message.
	 *
	 ...
	 * @return int
	 */
	function sz_get_the_thread_message_date_sent() {
		global $thread_template;
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_date_sent', strtotime( $thread_template->message->date_sent ) );
	}
 ...
 * @since 1.1.0
 */
function sz_the_thread_message_content() {
	echo sz_get_the_thread_message_content();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_thread_message_content() {
		global $thread_template;

		$content = $thread_template->message->message;

		// If user was deleted, mark content as deleted.
		if ( false === sz_core_get_core_userdata( sz_get_the_thread_message_sender_id() ) ) {
			$content = esc_html__( '[deleted]', 'sportszone' );
		}
		 ...
		 */
		return apply_filters( 'sz_get_the_thread_message_content', $content );
	}
 ...
 * @see SZ_Embed
 */
function sz_messages_embed() {
	add_filter( 'embed_post_id',         'sz_get_the_thread_message_id' );
	add_filter( 'sz_embed_get_cache',    'sz_embed_message_cache',      10, 3 );
	add_action( 'sz_embed_update_cache', 'sz_embed_message_save_cache', 10, 3 );
}
add_action( 'thread_loop_start', 'sz_messages_embed' );

/**
 * Fetch a private message item's cached embeds.
 *
 * Used during {@link SZ_Embed::parse_oembed()} via {@link sz_messages_embed()}.
 *
 * @since 2.2.0
 *
 ...
 */
function sz_embed_message_cache( $cache, $id, $cachekey ) {
	return sz_messages_get_meta( $id, $cachekey );
}
 ...
 * @param int    $id       The ID of the message item.
 */
function sz_embed_message_save_cache( $cache, $cachekey, $id ) {
	sz_messages_update_meta( $id, $cachekey, $cache );
}
