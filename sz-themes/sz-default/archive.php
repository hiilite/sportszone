<?php get_header(); ?>
	...
	<div id="content">
		...
		<?php do_action( 'sz_before_archive' ); ?>

		<div class="page" id="blog-archives" role="main">

			<h3 class="pagetitle"><?php printf( __( 'You are browsing the archive for %1$s.', 'sportszone' ), wp_title( false, false ) ); ?></h3>
		...
		<?php do_action( 'sz_after_archive' ); ?>
