<?php get_header(); ?>
	...
	<div id="content">
		...
		<?php do_action( 'sz_before_blog_home' ); ?>
		...
		<div class="page" id="blog-latest" role="main">
				...
				<?php while (have_posts()) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="author-box">
							...
							<?php if ( is_sticky() ) : ?>
								<span class="activity sticky-post"><?php _ex( 'Featured', 'Sticky post', 'sportszone' ); ?></span>
							<?php endif; ?>
						</div>
			...
			<?php else : ?>
				...
				<h2 class="center"><?php _e( 'Not Found', 'sportszone' ); ?></h2>
				<p class="center"><?php _e( 'Sorry, but you are looking for something that isn\'t here.', 'sportszone' ); ?></p>
		...
		<?php do_action( 'sz_after_blog_home' ); ?>
