...
class SZ_Events_List_Table extends WP_List_Table {
	...
	public function get_views() {
		...
		<ul class="subsubsub">
			...
			<li class="public"><a href="<?php echo esc_url( add_query_arg( 'event_status', 'public', $url_base ) ); ?>" class="<?php if ( 'public' == $this->view ) echo 'current'; ?>"><?php printf( _n( 'Public <span class="count badge badge-primary badge-pill">(%s)</span>', 'Public <span class="count">(%s)</span>', $this->event_counts['public'], 'sportszone' ), number_format_i18n( $this->event_counts['public'] ) ); ?></a> |</li>
