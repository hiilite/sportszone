 ...
 * @since 3.0.0
 */
class SZ_XProfile_Field_Type_Telephone extends SZ_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( 'Phone Number', 'xprofile field type', 'sportszone' );

		$this->set_format( '/^.*$/', 'replace' );

		/**
		 * Fires inside __construct() method for SZ_XProfile_Field_Type_Telephone class.
		 *
		 * @since 3.0.0
		 *
		 * @param SZ_XProfile_Field_Type_Telephone $this Current instance of the field type.
		 */
		do_action( 'sz_xprofile_field_type_telephone', $this );
	}
	...
	public function admin_field_html( array $raw_properties = array() ) {
		...
		<label for="<?php sz_the_profile_field_input_name(); ?>" class="screen-reader-text"><?php
			...
			esc_html_e( 'Phone Number', 'sportszone' );
		?></label>
