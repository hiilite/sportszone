 ...
 *
 * `SZ_XProfile_Meta_Query` is a helper that allows primary query classes, such
 ...
 * @since 2.3.0
 */
class SZ_XProfile_Meta_Query extends WP_Meta_Query {
	...
	public function parse_query_vars( $qv ) {
		...
		// SZ_XProfile_Query sets 'object_type' = '' by default.
	...
	public function get_sql( $type, $primary_table, $primary_id_column, $context = null ) {
		 ...
		 * }
		 */
		return apply_filters_ref_array( 'sz_xprofile_get_meta_sql', array( $sql, $this->queries, $type, $primary_table, $primary_id_column, $context ) );
	}
