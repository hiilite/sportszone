 ...
 * @since 2.1.0
 */
class SZ_XProfile_Field_Type_URL extends SZ_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( 'URL', 'xprofile field type', 'sportszone' );
		...
		/**
		 * Fires inside __construct() method for SZ_XProfile_Field_Type_URL class.
		 *
		 * @since 2.0.0
		 *
		 * @param SZ_XProfile_Field_Type_URL $this Current instance of
		 *                                         the field type URL.
		 */
		do_action( 'sz_xprofile_field_type_url', $this );
	}
	...
	public function edit_field_html( array $raw_properties = array() ) {
		...
		// fields types pass to {@link sz_the_profile_field_options()}.
		...
		$r = sz_parse_args( $raw_properties, array(
			'type'      => 'text',
			'inputmode' => 'url',
			'value'     => esc_url( sz_get_the_profile_field_edit_value() ),
		) ); ?>
