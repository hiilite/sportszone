<?php
/**
 * SportsZone XProfile Template Loop Class.
 *
 * @package SportsZone
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
class SZ_XProfile_Data_Template {
	 ...
	 *
	 * @see SZ_XProfile_Group::get() for more details about parameters.
	 *
	 * @since 1.5.0
	...
	public function __construct( $args = '' ) {
		...
		if ( ! is_array( $args ) || func_num_args() > 1 ) {
			_deprecated_argument( __METHOD__, '2.3.0', sprintf( __( 'Arguments passed to %1$s should be in an associative array. See the inline documentation at %2$s for more details.', 'sportszone' ), __METHOD__, __FILE__ ) );
		...
		$this->groups      = sz_xprofile_get_groups( $r );
