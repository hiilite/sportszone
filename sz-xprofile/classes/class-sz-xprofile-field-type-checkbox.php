 ...
 * @since 2.0.0
 */
class SZ_XProfile_Field_Type_Checkbox extends SZ_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( 'Checkboxes', 'xprofile field type', 'sportszone' );
		...
		/**
		 * Fires inside __construct() method for SZ_XProfile_Field_Type_Checkbox class.
		 *
		 * @since 2.0.0
		 *
		 * @param SZ_XProfile_Field_Type_Checkbox $this Current instance of
		 *                                              the field type checkbox.
		 */
		do_action( 'sz_xprofile_field_type_checkbox', $this );
	}
	...
	public function edit_field_options_html( array $args = array() ) {
		...
		$option_values = maybe_unserialize( SZ_XProfile_ProfileData::get_value_byid( $this->field_obj->id, $args['user_id'] ) );
		...
		for ( $k = 0, $count = count( $options ); $k < $count; ++$k ) {
			 ...
			 */
			$html .= apply_filters( 'sz_get_the_profile_field_options_checkbox', $new_html, $options[$k], $this->field_obj->id, $selected, $k );
		}
