<?php
/**
 * SportsZone XProfile Template Tags.
 *
 * @package SportsZone
 ...
 * @see SZ_XProfile_Group::get() for full description of `$args` array.
 *
 * @param array|string $args {
 *     Array of arguments. See SZ_XProfile_Group::get() for full description. Those arguments whose defaults differ
...
function sz_has_profile( $args = '' ) {
	...
	$hide_empty_fields_default = ( ! is_network_admin() && ! is_admin() && ! sz_is_user_profile_edit() && ! sz_is_register_page() );

	// We only need to fetch visibility levels when viewing your own profile.
	if ( sz_is_my_profile() || sz_current_user_can( 'sz_moderate' ) || sz_is_register_page() ) {
	...
	$profile_template = new SZ_XProfile_Data_Template( $r );
	 ...
	 * @param array  $r                Array of arguments passed into the SZ_XProfile_Data_Template class.
	 */
	return apply_filters( 'sz_has_profile', $profile_template->has_groups(), $profile_template, $r );
}
 ...
 * @return mixed
 */
function sz_profile_group_has_fields() {
	global $profile_template;
 ...
 */
function sz_field_css_class( $class = false ) {
	echo sz_get_field_css_class( $class );
}
	 ...
	 * @return string
	 */
	function sz_get_field_css_class( $class = false ) {
		global $profile_template;
		...
		$css_classes[] = 'visibility-' . esc_attr( sz_get_the_profile_field_visibility_level() );
		 ...
		 */
		$css_classes = apply_filters_ref_array( 'sz_field_css_classes', array( &$css_classes ) );
		 ...
		 */
		return apply_filters( 'sz_get_field_css_class', ' class="' . implode( ' ', $css_classes ) . '"' );
	}
...
function sz_field_has_data() {
	 ...
	 */
	return apply_filters( 'sz_field_has_data', $profile_template->field_has_data, $profile_template, $profile_template->field, $profile_template->field->id );
}
 ...
 * @return bool
 */
function sz_field_has_public_data() {
	global $profile_template;
	 ...
	 * @param string $value            Profile field ID being displayed.
	 */
	return apply_filters( 'sz_field_has_public_data', ( ! empty( $profile_template->field_has_data ) ), $profile_template, $profile_template->field, $profile_template->field->id );
}
 ...
 * @since 1.0.0
 */
function sz_the_profile_group_id() {
	echo sz_get_the_profile_group_id();
}
	 ...
	 * @return int
	 */
	function sz_get_the_profile_group_id() {
		global $group;
		 ...
		 */
		return (int) apply_filters( 'sz_get_the_profile_group_id', $group->id );
	}
 ...
 * @since 1.0.0
 */
function sz_the_profile_group_name() {
	echo sz_get_the_profile_group_name();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_group_name() {
		global $group;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_group_name', $group->name );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_group_slug() {
	echo sz_get_the_profile_group_slug();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_group_slug() {
		global $group;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_group_slug', sanitize_title( $group->name ) );
	}
 ...
 * @since 1.0.0
 */
function sz_the_profile_group_description() {
	echo sz_get_the_profile_group_description();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_group_description() {
		global $group;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_group_description', $group->description );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_group_edit_form_action() {
	echo sz_get_the_profile_group_edit_form_action();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_group_edit_form_action() {
		global $group;

		// Build the form action URL.
		$form_action = trailingslashit( sz_displayed_user_domain() . sz_get_profile_slug() . '/edit/group/' . $group->id );
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_group_edit_form_action', $form_action );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_group_field_ids() {
	echo sz_get_the_profile_group_field_ids();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_group_field_ids() {
		global $group;
 ...
 * @since 2.1.0
 */
function sz_the_profile_field_ids() {
	echo sz_get_the_profile_field_ids();
}
	/**
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_ids() {
		global $profile_template;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_field_ids', $field_ids );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_field_id() {
	echo sz_get_the_profile_field_id();
}
	 ...
	 * @return int
	 */
	function sz_get_the_profile_field_id() {
		global $field;
		 ...
		 */
		return (int) apply_filters( 'sz_get_the_profile_field_id', $field->id );
	}
 ...
 * @since 1.0.0
 */
function sz_the_profile_field_name() {
	echo sz_get_the_profile_field_name();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_name() {
		global $field;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_field_name', $field->name );
	}
 ...
 * @since 1.0.0
 */
function sz_the_profile_field_value() {
	echo sz_get_the_profile_field_value();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_value() {
		global $field;

		$field->data->value = sz_unserialize_profile_field( $field->data->value );
		 ...
		 * @param int    $id    ID for the profile field.
		 */
		return apply_filters( 'sz_get_the_profile_field_value', $field->data->value, $field->type, $field->id );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_field_edit_value() {
	echo sz_get_the_profile_field_edit_value();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_edit_value() {
		global $field;
		 ...
		 * @param int    $id          ID for the profile field.
		 */
		return apply_filters( 'sz_get_the_profile_field_edit_value', $field->data->value, $field->type, $field->id );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_field_type() {
	echo sz_get_the_profile_field_type();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_type() {
		global $field;
		 ...
		 * @param string $type Type for the profile field.
		 */
		return apply_filters( 'sz_the_profile_field_type', $field->type );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_field_description() {
	echo sz_get_the_profile_field_description();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_description() {
		global $field;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_field_description', $field->description );
	}
 ...
 * @since 1.1.0
 */
function sz_the_profile_field_input_name() {
	echo sz_get_the_profile_field_input_name();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_input_name() {
		global $field;
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_field_input_name', 'field_' . $field->id );
	}
 ...
 * object and rendered at actions that look like 'sz_field_12_errors'. This
 ...
 */
function sz_get_the_profile_field_errors_action() {
	global $field;
	return 'sz_field_' . $field->id . '_errors';
}
 ...
 */
function sz_the_profile_field_options( $args = array() ) {
	echo sz_get_the_profile_field_options( $args );
}
	/**
	 ...
	 */
	function sz_get_the_profile_field_options( $args = array() ) {
		global $field;
		...
		/**
		 * In some cases, the $field global is not an instantiation of the SZ_XProfile_Field class.
 ...
 * @since 1.1.0
 */
function sz_the_profile_field_is_required() {
	echo sz_get_the_profile_field_is_required();
}
	 ...
	 * @return bool
	 */
	function sz_get_the_profile_field_is_required() {
		global $field;
		 ...
		 */
		return (bool) apply_filters( 'sz_get_the_profile_field_is_required', $retval, $field->id );
	}
 ...
 * @since 1.6.0
 */
function sz_the_profile_field_visibility_level() {
	echo sz_get_the_profile_field_visibility_level();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_visibility_level() {
		global $field;
		...
		if ( sz_is_register_page() && ! empty( $_POST['field_' . $field->id . '_visibility'] ) ) {
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_field_visibility_level', $retval );
	}
 ...
 * @since 1.6.0
 */
function sz_the_profile_field_visibility_level_label() {
	echo sz_get_the_profile_field_visibility_level_label();
}
	 ...
	 * @return string
	 */
	function sz_get_the_profile_field_visibility_level_label() {
		global $field;
		...
		$fields = sz_xprofile_get_visibility_levels();
		 ...
		 */
		return apply_filters( 'sz_get_the_profile_field_visibility_level_label', $fields[ $level ]['label'], $level );
	}
 ...
 * @return string
 */
function sz_unserialize_profile_field( $value ) {
 ...
 * @since 1.2.0
 *
 * @param string|array $args Array of arguments for field data. See {@link sz_get_profile_field_data}
 */
function sz_profile_field_data( $args = '' ) {
	echo sz_get_profile_field_data( $args );
}
	 ...
	 * @return mixed
	 */
	function sz_get_profile_field_data( $args = '' ) {
		 ...
		 */
		return apply_filters( 'sz_get_profile_field_data', xprofile_get_field_data( $r['field'], $r['user_id'] ), $r );
	}
 ...
 * @return array $groups
 */
function sz_profile_get_field_groups() {

	$groups = wp_cache_get( 'all', 'sz_xprofile_groups' );
	if ( false === $groups ) {
		$groups = sz_xprofile_get_groups( array( 'fetch_fields' => true ) );
		wp_cache_set( 'all', $groups, 'sz_xprofile_groups' );
	}
	 ...
	 */
	return apply_filters( 'sz_profile_get_field_groups', $groups );
}
 ...
 */
function sz_profile_has_multiple_groups() {
	$has_multiple_groups = count( (array) sz_profile_get_field_groups() ) > 1;
	 ...
	 */
	return (bool) apply_filters( 'sz_profile_has_multiple_groups', $has_multiple_groups );
}
 ...
 * @since 1.0.0
 */
function sz_profile_group_tabs() {
	echo sz_get_profile_group_tabs();
 ...
 * @return string
 */
function sz_get_profile_group_tabs() {

	// Get field group data.
	$groups     = sz_profile_get_field_groups();
	$group_name = sz_get_profile_group_name();
	$tabs       = array();
	...
	for ( $i = 0, $count = count( $groups ); $i < $count; ++$i ) {
		...
		$link   = trailingslashit( sz_displayed_user_domain() . sz_get_profile_slug() . '/edit/group/' . $groups[ $i ]->id );
 ...
 * @return string|null
 */
function sz_profile_group_name( $deprecated = true ) {
	if ( ! $deprecated ) {
		return sz_get_profile_group_name();
	} else {
		echo sz_get_profile_group_name();
	}
}
	 ...
	 * @return string
	 */
	function sz_get_profile_group_name() {

		// Check action variable.
		$group_id = sz_action_variable( 1 );
		if ( empty( $group_id ) || ! is_numeric( $group_id ) ) {
			$group_id = 1;
		}

		// Check for cached group.
		$group = new SZ_XProfile_Group( $group_id );
		 ...
		 */
		return apply_filters( 'sz_get_profile_group_name', $group->name, $group_id );
	}
 ...
 * @since 1.0.0
 */
function sz_profile_last_updated() {

	$last_updated = sz_get_profile_last_updated();

	if ( empty( $last_updated ) ) {
		_e( 'Profile not recently updated.', 'sportszone' );
	} else {
		echo $last_updated;
	}
}
	 ...
	 * @return bool|string
	 */
	function sz_get_profile_last_updated() {

		$last_updated = sz_get_user_meta( sz_displayed_user_id(), 'profile_last_updated', true );
		...
		if ( ! empty( $last_updated ) ) {
			 ...
			 */
			return apply_filters( 'sz_get_profile_last_updated', sprintf( __( 'Profile updated %s', 'sportszone' ), sz_core_time_since( strtotime( $last_updated ) ) ) );
		}
 ...
 * @since 1.1.0
 */
function sz_current_profile_group_id() {
	echo sz_get_current_profile_group_id();
}
	 ...
	 * @return int
	 */
	function sz_get_current_profile_group_id() {
		$profile_group_id = sz_action_variable( 1 );
		 ...
		 */
		return (int) apply_filters( 'sz_get_current_profile_group_id', $profile_group_id );
	}
 ...
 * @since 1.1.0
 */
function sz_avatar_delete_link() {
	echo sz_get_avatar_delete_link();
}
	 ...
	 * @return string
	 */
	function sz_get_avatar_delete_link() {
		 ...
		 */
		return apply_filters( 'sz_get_avatar_delete_link', wp_nonce_url( sz_displayed_user_domain() . sz_get_profile_slug() . '/change-avatar/delete-avatar/', 'sz_delete_avatar_link' ) );
	}
 ...
 * @since 1.0.0
 */
function sz_edit_profile_button() {
	sz_button( array(
		'id'                => 'edit_profile',
		'component'         => 'xprofile',
		'must_be_logged_in' => true,
		'block_self'        => true,
		'link_href'         => trailingslashit( sz_displayed_user_domain() . sz_get_profile_slug() . '/edit' ),
		'link_class'        => 'edit',
		'link_text'         => __( 'Edit Profile', 'sportszone' ),
	) );
}
 ...
 * @since 1.6.0
 *
 * @param array|string $args Args for the radio buttons. See {@link sz_profile_get_visibility_radio_buttons}
 */
function sz_profile_visibility_radio_buttons( $args = '' ) {
	echo sz_profile_get_visibility_radio_buttons( $args );
}
	/**
	 ...
	 */
	function sz_profile_get_visibility_radio_buttons( $args = '' ) {
		...
		if ( ! empty( $r['field_id'] ) ) :
			...
			<?php if ( sz_current_user_can( 'sz_xprofile_change_field_visibility' ) ) : ?>
				...
				<?php foreach( sz_xprofile_get_visibility_levels() as $level ) : ?>

					<?php printf( $r['before_radio'], esc_attr( $level['id'] ) ); ?>

					<label for="<?php echo esc_attr( 'see-field_' . $r['field_id'] . '_' . $level['id'] ); ?>">
						<input type="radio" id="<?php echo esc_attr( 'see-field_' . $r['field_id'] . '_' . $level['id'] ); ?>" name="<?php echo esc_attr( 'field_' . $r['field_id'] . '_visibility' ); ?>" value="<?php echo esc_attr( $level['id'] ); ?>" <?php checked( $level['id'], sz_get_the_profile_field_visibility_level() ); ?> />
		 ...
		 */
		return apply_filters( 'sz_profile_get_visibility_radio_buttons', $retval, $r, $args );
	}
 ...
 * @since 2.0.0
 *
 * @param array|string $args Args for the select list. See {@link sz_profile_get_settings_visibility_select}
 */
function sz_profile_settings_visibility_select( $args = '' ) {
	echo sz_profile_get_settings_visibility_select( $args );
}
	/**
	 ...
	 * @return string $retval
	 */
	function sz_profile_get_settings_visibility_select( $args = '' ) {
		...
		$r = sz_parse_args( $args, array(
			...
			'after_controls'   => '',
			'class'            => 'sz-xprofile-visibility',
			'label_class'      => 'sz-screen-reader-text',
			'notoggle_tag'     => 'span',
		...
		if ( ! empty( $r['field_id'] ) ) :
			...
			<?php echo $r['before_controls']; ?>
				...
				<label for="<?php echo esc_attr( 'field_' . $r['field_id'] ) ; ?>_visibility" class="<?php echo esc_attr( $r['label_class'] ); ?>"><?php
					...
					_e( 'Select visibility', 'sportszone' );
				?></label>
				<select class="<?php echo esc_attr( $r['class'] ); ?>" name="<?php echo esc_attr( 'field_' . $r['field_id'] ) ; ?>_visibility" id="<?php echo esc_attr( 'field_' . $r['field_id'] ) ; ?>_visibility">
					...
					<?php foreach ( sz_xprofile_get_visibility_levels() as $level ) : ?>
						...
						<option value="<?php echo esc_attr( $level['id'] ); ?>" <?php selected( $level['id'], sz_get_the_profile_field_visibility_level() ); ?>><?php echo esc_html( $level['label'] ); ?></option>
			...
			<?php else : ?>
				...
				<<?php echo esc_html( $r['notoggle_tag'] ); ?> class="<?php echo esc_attr( $r['notoggle_class'] ); ?>"><?php sz_the_profile_field_visibility_level_label(); ?></<?php echo esc_html( $r['notoggle_tag'] ); ?>>
		 ...
		 * @param array  $args   Original passed in arguments to be used with display.
		 */
		return apply_filters( 'sz_profile_settings_visibility_select', $retval, $r, $args );
	}
 ...
 * @since 2.4.0
 */
function sz_the_profile_field_required_label() {
	echo sz_get_the_profile_field_required_label();
}
	 ...
	 */
	function sz_get_the_profile_field_required_label() {
		$retval = '';

		if ( sz_get_the_profile_field_is_required() ) {
			$translated_string = __( '(required)', 'sportszone' );

			$retval = ' <span class="sz-required-field-label">';
			$retval .= apply_filters( 'sz_get_the_profile_field_required_label', $translated_string, sz_get_the_profile_field_id() );
			$retval .= '</span>';
