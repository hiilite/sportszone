 ...
 * This field is
 */
class Field_Type_Birthdate extends \SZ_XProfile_Field_Type_Datebox {

	public function __construct() {

	    parent::__construct();

		$this->name     = _x( 'Birthdate Selector', 'xprofile field type', 'sz-xprofile-custom-field-types' );
		$this->category = _x( 'Custom Fields', 'xprofile field type category', 'sz-xprofile-custom-field-types' );

		do_action( 'sz_xprofile_field_type_birthdate', $this );
	}
	...
	public function admin_new_field_html( \SZ_XProfile_Field $current_field, $control_type = '' ) {
        ...
        <div id="<?php echo esc_attr( $type ); ?>" class="postbox sz-options-box" style="<?php echo esc_attr( $class ); ?> margin-top: 15px;">
            <table class="form-table sz-date-options">
                <tr>
                    <th scope="row">
						<?php esc_html_e( 'Date format', 'sz-xprofile-custom-field-types' ); ?>
                    </th>
                        ...
                        <fieldset>
                            ...
                            <div class="sz-date-format-option">
                                <label for="date-format-elapsed">
                                    ...
                                    <span class="date-format-label" id="date-format-elapsed-setting"><?php esc_html_e( 'Time elapsed', 'sz-xprofile-custom-field-types' ); ?></span> <?php _e( '<code>4 years ago</code>, <code>4 years from now</code>', 'sz-xprofile-custom-field-types' ); ?>
                                </label>
                            </div>
                            ...
                            <div class="sz-date-format-option">
                                <label for="date-format-custom">
                                    ...
                                    <span class="date-format-label"><?php esc_html_e( 'Custom:', 'sz-xprofile-custom-field-types' ); ?></span>
                                </label>
                                <label for="date-format-custom-value" class="screen-reader-text"><?php esc_html_e( 'Enter custom time format', 'sz-xprofile-custom-field-types' ); ?></label>
                                <input type="text" name="field-settings[date_format_custom]" id="date-format-custom-value" class="date-format-custom-value" value="<?php echo esc_attr( $settings['date_format_custom'] ); ?>" aria-describedby="date-format-custom-example" /> <span class="screen-reader-text"><?php esc_html_e( 'Example:', 'sz-xprofile-custom-field-types' ); ?></span><span class="date-format-custom-example" id="date-format-custom-sample"><?php if ( $settings['date_format_custom'] ) : ?><?php echo esc_html( date_i18n( $settings['date_format_custom'] ) ); endif; ?></span><span class="spinner" id="date-format-custom-spinner" aria-hidden="true"></span>

                                <p><a href="https://codex.wordpress.org/Formatting_Date_and_Time"><?php esc_html_e( 'Documentation on date and time formatting', 'sz-xprofile-custom-field-types' ); ?></a></p>
                            </div>
                ...
                <tr>
                    <th scope="row">
						<?php esc_html_e( 'Range', 'sz-xprofile-custom-field-types' ); ?>
                    </th>
                            ...
                            <div class="sz-date-format-option">
                                <div class="sz-date-range-type-label">
                                    <label for="range_type_absolute">
										...
										<?php esc_html_e( 'Absolute', 'sz-xprofile-custom-field-types' ); ?>
                                    </label>
                                </div>

                                <div class="sz-date-range-type-values">
                                    <label for="field-settings[range_absolute_start]" aria-label="Year"><?php esc_html_e( 'Start:', 'sz-xprofile-custom-field-types' ); ?></label>
                                    ...
                                    <label for="field-settings[range_absolute_end]" aria-label="Year"><?php esc_html_e( 'End:', 'sz-xprofile-custom-field-types' ); ?></label>
                            ...
                            <div class="sz-date-format-option">
                                <div class="sz-date-range-type-label">
                                    <label for="range_type_relative">
										...
										<?php esc_html_e( 'Relative', 'sz-xprofile-custom-field-types' ); ?>
                                    </label>
                                </div>

                                <div class="sz-date-range-type-values">
                                    <label for="field-settings[range_relative_start]"><?php esc_html_e( 'Start:', 'sz-xprofile-custom-field-types' ); ?></label>
                                    ...
                                    <label class="screen-reader-text" for="field-settings[range_relative_start_type]"><?php esc_html_e( 'Select range', 'sz-xprofile-custom-field-types' ); ?></label>
									<?php printf( '<select name="field-settings[range_relative_start_type]" id="field-settings[range_relative_start_type]"><option value="past" %s>%s</option><option value="future" %s>%s</option></select>',
										...
										esc_attr__( 'years ago', 'sz-xprofile-custom-field-types' ),
										selected( true, $settings['range_relative_start'] > 0, false ),
										esc_attr__( 'years from now', 'sz-xprofile-custom-field-types' )
									);
									?>

                                    <label for="field-settings[range_relative_end]"><?php esc_html_e( 'End:', 'sz-xprofile-custom-field-types' ); ?></label>
									...
									?>
                                    <label class="screen-reader-text" for="field-settings[range_relative_end_type]"><?php esc_html_e( 'Select range', 'sz-xprofile-custom-field-types' ); ?></label>
            ...
            <h3><?php esc_html_e( 'Show age:', 'sz-xprofile-custom-field-types' ); ?></h3>
            <div class="inside">
                <p>
			        <?php _e( 'Check this if you want to show age instead of birthdate:', 'sz-xprofile-custom-field-types' ); ?>

                    <input type="checkbox" name="szxcftr_birtdate_show_age" id="szxcftr_birtdate_show_age" value="1" <?php checked(1, $show_age ); ?>/>
                </p>

                <p>
		            <?php _e( 'Hide months while showing age?', 'sz-xprofile-custom-field-types' ); ?>

                    <input type="checkbox" name="szxcftr_birtdate_hide_months" id="szxcftr_birtdate_hide_months" value="1" <?php checked(1, $hide_months ); ?>/>
                </p>
            </div>

            <h3><?php esc_html_e( 'Define a minimum age:', 'sz-xprofile-custom-field-types' ); ?></h3>
            <div class="inside">
                <p>
			        <?php _e( 'Minimum age:', 'sz-xprofile-custom-field-types' ); ?>
                    <input type="number" name="szxcftr_birtdate_min_age" id="szxcftr_birtdate_min_age" min="1" value="<?php echo esc_attr( $min_age );?>"/>
                </p>
            </div>
        </div>
		<?php
	...
	public static function display_filter( $field_value, $field_id = 0 ) {
		...
		if ( $age_interval->m && ! self::hide_months( $field_id ) ) {
			$age .= sprintf( _n( ', %s month', ', %s months', $age_interval->m, 'sz-xprofile-custom-field-types' ), $age_interval->m );
		}

		return apply_filters( 'szxcftr_birthdate_age_display_data', $age, $field_id );
	}

	public static function hide_months( $field_id ) {
		return (bool) sz_xprofile_get_meta( $field_id, 'field', 'hide_months',  true );
	}

	public static function show_age( $field_id ) {
		return (bool) sz_xprofile_get_meta( $field_id, 'field', 'show_age',  true );
    }

	public static function get_min_age( $field_id ) {
		return  sz_xprofile_get_meta( $field_id, 'field', 'min_age',  true );
    }
}
