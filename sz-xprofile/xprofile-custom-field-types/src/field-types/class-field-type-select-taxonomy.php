...
class Field_Type_Select_Taxonomy extends \SZ_XProfile_Field_Type implements Field_Type_Selectable {

    public function __construct() {

	    parent::__construct();

	    $this->name     = _x( 'Custom Taxonomy Selector', 'xprofile field type', 'sz-xprofile-custom-field-types' );
	    $this->category = _x( 'Custom Fields', 'xprofile field type category', 'sz-xprofile-custom-field-types' );

		$this->supports_options = false;

		do_action( 'sz_xprofile_field_type_select_custom_taxonomy', $this );
	}
	...
	public function edit_field_options_html( array $args = array() ) {
		...
		$term_selected = \SZ_XProfile_ProfileData::get_value_byid( $this->field_obj->id, $args['user_id'] );
		...
		echo apply_filters( 'sz_get_the_profile_field_select_custom_taxonomy', $html, $args['type'], $term_selected, $this->field_obj->id );
	}
			...
			<?php else : ?>
                ...
                <div class="inside">
                    <p>
                        ...
                        <select name="szxcftr_selected_taxonomy" id="szxcftr_selected_taxonomy">
                            <option value=""><?php _e( 'Select...', 'sz-xprofile-custom-field-types' ); ?></option>
