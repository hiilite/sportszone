 ...
 * would cause the function to attempt to load the SZXProfileCFTR\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/sportszone-xprofile-custom-fields-types/src/bar/baz/class-qux.php:
 *
 *      new SZXProfileCFTR\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/sportszone-xprofile-custom-fields-types/src/bar/baz-xyz/class-qux.php
 * The path/directory name should be all lowercase and the the class file is named as 'class-$classname.php'
 */
class Autoloader {

	/**
	 * Namespace root. eg. SZXProfileCFTR\\(escaped slashes);
	 *
	 * @var string
	 */
	 ...
	 * After registering this autoload function with SPL, the following line
	 * would cause the function to attempt to load the \SZXProfileCFTR\Bar\Baz\Qux class
	 * from /path/to/project/sportszone-xprofile-custom-fields-types/src/bar/baz/class-qux.php:
	 *
	 *      new \SZXProfileCFTR\Baz\Qux;
	 *  maps to /path/to/sportszone-xprofile-custom-fields-types/src/baz/class-qux.php
	 * The path/directory name should be all lowercase and the the class file is named as 'class-$classname.php'
