...
/**
 * Plugin Name: SportsZone Xprofile Custom Field Types
 * Plugin URI: https://buddydev.com/plugins/sportszone-xprofile-custom-field-types/
 ...
 * Text Domain:  sz-xprofile-custom-field-types
 * Domain Path:  /languages
 */

use SZXProfileCFTR\Bootstrap\Autoloader;
use SZXProfileCFTR\Bootstrap\Bootstrapper;
use SZXProfileCFTR\Core\Data_Store;
...
class SZ_Xprofile_CFTR {
	...
	private function bootstrap() {
		...
		// Register autoloader.
		spl_autoload_register( new Autoloader( 'SZXProfileCFTR\\', __DIR__ . '/src/' ) );
	...
	public function on_activation() {
		update_option( 'szxcftr_notices', array() );
	}
 ...
 *
 * @return SZ_Xprofile_CFTR
 */
function sz_xprofile_cftr() {
	return SZ_Xprofile_CFTR::get_instance();
}
