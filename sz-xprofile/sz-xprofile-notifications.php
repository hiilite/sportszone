<?php
/**
 * SportsZone XProfile Notifications.
 *
 * @package    SportsZone
...
function xprofile_format_notifications( $action, $item_id, $secondary_item_id, $total_items, $format = 'string' ) {
	switch ( $action ) {
		default:
			 ...
			 */
			$custom_action_notification = apply_filters( 'sz_xprofile_' . $action . '_notification', null, $item_id, $secondary_item_id, $total_items, $format );
