 ...
 * @since 1.2.0
 */
do_action( 'sz_before_blogs_loop' ); ?>
...
<?php if ( sz_has_blogs( sz_ajax_querystring( 'blogs' ) ) ) : ?>
	 ...
	 * @since 1.1.0
	 */
	do_action( 'sz_after_directory_blogs_list' ); ?>
