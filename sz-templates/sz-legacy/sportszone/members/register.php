...
<div id="sportszone">
	...
	/**
	 * Fires at the top of the SportsZone member registration page template.
	 *
	 * @since 1.1.0
	 */
	do_action( 'sz_before_register_page' ); ?>
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'registration-disabled' == sz_get_current_signup_step() ) : ?>
			 ...
			 * @since 1.5.0
			 */
			do_action( 'sz_before_registration_disabled' ); ?>
			 ...
			 * @since 1.5.0
			 */
			do_action( 'sz_after_registration_disabled' ); ?>
		...
		<?php if ( 'request-details' == sz_get_current_signup_step() ) : ?>
			 ...
			 * @since 1.1.0
			 */
			do_action( 'sz_before_account_details_fields' ); ?>

			<div class="register-section" id="basic-details-section">

				<?php /***** Basic Account Details ******/ ?>

				<h2><?php _e( 'Account Details', 'sportszone' ); ?></h2>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_signup_username_errors' ); ?>
				<input type="text" name="signup_username" id="signup_username" value="<?php sz_signup_username_value(); ?>" <?php sz_form_field_attributes( 'username' ); ?>/>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_signup_email_errors' ); ?>
				<input type="email" name="signup_email" id="signup_email" value="<?php sz_signup_email_value(); ?>" <?php sz_form_field_attributes( 'email' ); ?>/>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_signup_password_errors' ); ?>
				<input type="password" name="signup_password" id="signup_password" value="" class="password-entry" <?php sz_form_field_attributes( 'password' ); ?>/>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_signup_password_confirm_errors' ); ?>
				<input type="password" name="signup_password_confirm" id="signup_password_confirm" value="" class="password-entry-confirm" <?php sz_form_field_attributes( 'password' ); ?>/>
				 ...
				 * @since 1.9.0
				 */
				do_action( 'sz_account_details_fields' ); ?>
			 ...
			 * @since 1.1.0
			 */
			do_action( 'sz_after_account_details_fields' ); ?>
			...
			<?php if ( sz_is_active( 'xprofile' ) ) : ?>
				 ...
				 * @since 1.2.4
				 */
				do_action( 'sz_before_signup_profile_fields' ); ?>

				<div class="register-section" id="profile-details-section">

					<h2><?php _e( 'Profile Details', 'sportszone' ); ?></h2>
					...
					<?php while ( sz_profile_fields() ) : sz_the_profile_field(); ?>
						...
						<div<?php sz_field_css_class( 'editfield' ); ?>>
							...
							if ( sz_current_user_can( 'sz_xprofile_change_field_visibility' ) ) : ?>
					 ...
					 * @since 1.9.0
					 */
					do_action( 'sz_signup_profile_fields' ); ?>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_after_signup_profile_fields' ); ?>
			...
			<?php if ( sz_get_blog_signup_allowed() ) : ?>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_before_blog_details_fields' ); ?>

				<?php /***** Blog Creation Details ******/ ?>

				<div class="register-section" id="blog-details-section">

					<h2><?php _e( 'Blog Details', 'sportszone' ); ?></h2>

					<p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( (int) sz_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes, I\'d like to create a new site', 'sportszone' ); ?></label></p>
					...
					<div id="blog-details"<?php if ( (int) sz_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
						 ...
						 * @since 1.1.0
						 */
						do_action( 'sz_signup_blog_url_errors' ); ?>

						<?php if ( is_subdomain_install() ) : ?>
							http:// <input type="text" name="signup_blog_url" id="signup_blog_url" value="<?php sz_signup_blog_url_value(); ?>" /> .<?php sz_signup_subdomain_base(); ?>
						<?php else : ?>
						 ...
						 * @since 1.1.0
						 */
						do_action( 'sz_signup_blog_title_errors' ); ?>
						...
						<fieldset class="register-site">
							 ...
							 * @since 1.1.0
							 */
							do_action( 'sz_signup_blog_privacy_errors' ); ?>

							<label for="signup_blog_privacy_public"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == sz_get_signup_blog_privacy_value() || !sz_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes', 'sportszone' ); ?></label>
							<label for="signup_blog_privacy_private"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == sz_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'No', 'sportszone' ); ?></label>
						</fieldset>
						 ...
						 * @since 1.9.0
						 */
						do_action( 'sz_blog_details_fields' ); ?>
				 ...
				 * @since 1.1.0
				 */
				do_action( 'sz_after_blog_details_fields' ); ?>
			 ...
			 * @since 1.1.0
			 */
			do_action( 'sz_before_registration_submit_buttons' ); ?>
			 ...
			 * @since 1.1.0
			 */
			do_action( 'sz_after_registration_submit_buttons' ); ?>
		...
		<?php if ( 'completed-confirmation' == sz_get_current_signup_step() ) : ?>
			 ...
			 * @since 1.5.0
			 */
			do_action( 'sz_before_registration_confirmed' ); ?>
			 ...
			 * @since 1.5.0
			 */
			do_action( 'sz_after_registration_confirmed' ); ?>
		 ...
		 * @since 1.1.0
		 */
		do_action( 'sz_custom_signup_steps' ); ?>
	...
	/**
	 * Fires at the bottom of the SportsZone member registration page template.
	 *
	 * @since 1.1.0
	 */
	do_action( 'sz_after_register_page' ); ?>
