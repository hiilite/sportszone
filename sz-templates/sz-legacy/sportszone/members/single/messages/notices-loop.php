<?php
/**
 * SportsZone - Members Single Messages Notice Loop
 *
 * @package SportsZone
 ...
 * @since 1.2.0
 */
do_action( 'sz_before_notices_loop' ); ?>
...
<?php if ( sz_has_message_threads() ) : ?>
	 ...
	 * @since 1.2.0
	 */
	do_action( 'sz_after_notices_pagination' ); ?>
	<?php
	...
	<table id="message-threads" class="messages-notices sitewide-notices">
		<?php while ( sz_message_threads() ) : sz_message_thread(); ?>
			<tr id="notice-<?php sz_message_notice_id(); ?>" class="<?php sz_message_css_class(); ?>">
				 ...
				 * @since 1.2.0
				 */
				do_action( 'sz_notices_list_item' ); ?>

				<td width="10%">
					<a class="button" href="<?php sz_message_activate_deactivate_link(); ?>" class="confirm"><?php sz_message_activate_deactivate_text(); ?></a>
					<a class="button" href="<?php sz_message_notice_delete_link(); ?>" class="confirm"><?php esc_html_e( "Delete Message", 'sportszone' ); ?></a>
				</td>
			</tr>
		<?php endwhile; ?>
 ...
 * @since 1.2.0
 */
do_action( 'sz_after_notices_loop' );
