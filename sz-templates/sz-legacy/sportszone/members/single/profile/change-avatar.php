...
<h2><?php _e( 'Change Profile Photo', 'sportszone' ); ?></h2>
 ...
 * @since 1.1.0
 */
do_action( 'sz_before_profile_avatar_upload_content' ); ?>

<?php if ( !(int)sz_get_option( 'sz-disable-avatar-uploads' ) ) : ?>

	<p><?php _e( 'Your profile photo will be used on your profile and throughout the site. If there is a <a href="http://gravatar.com">Gravatar</a> associated with your account email we will use that, or you can upload an image from your computer.', 'sportszone' ); ?></p>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == sz_get_avatar_admin_step() ) : ?>
			...
			<?php if ( sz_get_user_has_avatar() ) : ?>
				...
				<p><a class="button edit" href="<?php sz_avatar_delete_link(); ?>"><?php _e( 'Delete My Profile Photo', 'sportszone' ); ?></a></p>
			<?php endif; ?>
		...
		<?php if ( 'crop-image' == sz_get_avatar_admin_step() ) : ?>
			...
			<h5><?php _e( 'Crop Your New Profile Photo', 'sportszone' ); ?></h5>
...
<?php else : ?>
	...
	<p><?php _e( 'Your profile photo will be used on your profile and throughout the site. To change your profile photo, please create an account with <a href="https://gravatar.com">Gravatar</a> using the same email address as you used to register with this site.', 'sportszone' ); ?></p>
 ...
 * @since 1.1.0
 */
do_action( 'sz_after_profile_avatar_upload_content' );
