...
<?php if ( sz_has_members( 'type=alphabetical&include=' . sz_get_friendship_requests() ) ) : ?>
		...
		<?php while ( sz_members() ) : sz_the_member(); ?>
			...
			<li id="friendship-<?php sz_friend_friendship_id(); ?>">
				...
				<div class="item">
					 ...
					 * @since 1.1.0
					 */
					do_action( 'sz_friend_requests_item' );
					?>
				</div>
				...
				<div class="action">
					 ...
					 * @since 1.1.0
					 */
					do_action( 'sz_friend_requests_item_action' ); ?>
				</div>
			</li>
	 ...
	 * @since 1.1.0
	 */
	do_action( 'sz_friend_requests_content' ); ?>
 ...
 * @since 1.2.0
 */
do_action( 'sz_after_member_friend_requests_content' );
