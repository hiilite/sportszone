 ...
 * @since 2.7.0
 */
do_action( 'sz_before_group_admin_form' ); ?>
...
<form action="<?php sz_group_admin_form_action(); ?>" name="group-settings-form" id="group-settings-form" class="standard-form" method="post" enctype="multipart/form-data">
	...
	<?php if ( sz_is_group_admin_screen( sz_action_variable() ) ) : ?>

		<?php sz_get_template_part( 'groups/single/admin/' . sz_action_variable() ); ?>
 ...
 * @since 2.7.0
 */
do_action( 'sz_after_group_admin_form' );
