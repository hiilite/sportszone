 ...
 */
function sz_nouveau_xprofile_hook( $when = '', $suffix = '' ) {
	$hook = array( 'sz' );
 ...
 * @since 3.0.0
 */
function sz_nouveau_xprofile_edit_visibilty() {
	/**
	...
	sz_get_template_part( 'members/single/parts/profile-visibility' );
 ...
 * @since 3.0.0
 */
function sz_nouveau_base_account_has_xprofile() {
	return (bool) sz_has_profile(
		array(
			'profile_group_id' => 1,
