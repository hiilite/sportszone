...
<script type="text/html" id="tmpl-activity-post-form-feedback">
	<span class="sz-icon" aria-hidden="true"></span><p>{{{data.message}}}</p>
</script>
...
<script type="text/html" id="tmpl-activity-post-form-options">
	<?php sz_nouveau_activity_hook( '', 'post_form_options' ); ?>
</script>

<script type="text/html" id="tmpl-activity-post-form-buttons">
	<button type="button" class="button dashicons {{data.icon}}" data-button="{{data.id}}"><span class="sz-screen-reader-text">{{data.caption}}</span></button>
</script>
...
<script type="text/html" id="tmpl-activity-target-item">
	...
	<span class="sz-item-name">{{data.name}}</span>

	<# if ( data.selected ) { #>
		<button type="button" class="sz-remove-item dashicons dashicons-no" data-item_id="{{data.id}}">
			<span class="sz-screen-reader-text"><?php echo esc_html_x( 'Remove item', 'button', 'sportszone' ); ?></span>
		</button>
	<# } #>
</script>
