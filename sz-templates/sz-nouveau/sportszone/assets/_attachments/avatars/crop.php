...
?>
<script id="tmpl-sz-avatar-item" type="text/html">
	...
	<div class="avatar-crop-management">
		...
		<div id="avatar-crop-actions">
			<button type="button" class="button avatar-crop-submit"><?php echo esc_html_x( 'Crop Image', 'button', 'sportszone' ); ?></button>
		</div>
	</div>
</script>
