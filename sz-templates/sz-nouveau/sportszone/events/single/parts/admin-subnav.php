<?php
/**
 * SportsZone Single Events Admin Navigation
 *
 * @since 3.0.0
 * @version 3.0.0
 */
...
<nav class="<?php sz_nouveau_single_item_subnav_classes(); ?>" id="subnav" role="navigation" aria-label="<?php esc_attr_e( 'Event administration menu', 'sportszone' ); ?>">

	<?php if ( sz_nouveau_has_nav( array( 'object' => 'event_manage' ) ) ) : ?>
