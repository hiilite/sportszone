<?php
/**
 * SportsZone - Select Team
 *
 *	If paid event, select the team you want to attend the event with to send invite to all memebers
 *
 * @since 3.0.0
 * @version 3.0.0
 */
...
<h2 class="sz-screen-title">
	<?php esc_html_e( 'My Teams', 'sportszone' ); ?>
</h2>
