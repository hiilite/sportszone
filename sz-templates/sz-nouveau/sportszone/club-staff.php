...
$team = new SP_Club( $id );
$members = $team->staff();
$link_staff = get_option( 'sportszone_club_link_staff', 'no' ) === 'yes' ? true : false;
...
foreach ( $members as $staff ):
	...
	<?php
	sz_get_template( 'staff-photo.php', array( 'id' => $id ) );
	sz_get_template( 'staff-details.php', array( 'id' => $id ) );
endforeach;
