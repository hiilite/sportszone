...
if ( get_option( 'sportszone_player_show_details', 'yes' ) === 'no' ) return;

if ( ! isset( $id ) )
	$id = get_the_ID();

$defaults = array(
	'show_number' => get_option( 'sportszone_player_show_number', 'no' ) == 'yes' ? true : false,
	'show_name' => get_option( 'sportszone_player_show_name', 'no' ) == 'yes' ? true : false,
	'show_nationality' => get_option( 'sportszone_player_show_nationality', 'yes' ) == 'yes' ? true : false,
	'show_positions' => get_option( 'sportszone_player_show_positions', 'yes' ) == 'yes' ? true : false,
	'show_current_teams' => get_option( 'sportszone_player_show_current_teams', 'yes' ) == 'yes' ? true : false,
	'show_past_teams' => get_option( 'sportszone_player_show_past_teams', 'yes' ) == 'yes' ? true : false,
	'show_leagues' => get_option( 'sportszone_player_show_leagues', 'no' ) == 'yes' ? true : false,
	'show_seasons' => get_option( 'sportszone_player_show_seasons', 'no' ) == 'yes' ? true : false,
	'show_nationality_flags' => get_option( 'sportszone_player_show_flags', 'yes' ) == 'yes' ? true : false,
...
if ( $show_name ):
	$common[ __( 'Name', 'sportszone' ) ] = $player->post->post_title;
endif;
...
$data = apply_filters( 'sportszone_player_details', $data, $id );
