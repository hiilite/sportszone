...
$defaults = array(
	...
	'link_posts' => get_option( 'sportszone_link_teams', 'yes' ) == 'yes' ? true : false,
);
...
<?php echo $gallery_div; ?>
	...
	foreach( $data as $team_id => $row ):
	    ...
	    sz_get_template( 'team-gallery-thumbnail.php', array(
	    	'id' => $team_id,
	    	'itemtag' => $itemtag,
	    	'icontag' => $icontag,
	...
	if ( $show_all_teams_link ) {
		echo '<div class="sp-team-gallery-link sp-gallery-link sp-view-all-link"><a href="' . get_permalink( $id ) . '">' . __( 'View all teams', 'sportszone' ) . '</a></div>';
	}
